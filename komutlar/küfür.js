...
exports.run = async (bot, message, args) => { 
  ...
  if (args[0] == 'aç') 
  { db.set(`kufur_${message.guild.id}`, 'acik').then(i => { message.channel.send('✅ Küfur Engel başarıyla açıldı! Üyeleri Yasakla yetkisine sahip olanların küfürü engellenmicektir.') }) } 
...
exports.conf = { enabled: true, guildOnly: false, 
                aliases: ['küfür'], permLevel: 0 }; exports.help = { 
